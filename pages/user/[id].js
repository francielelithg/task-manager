    ...
    <MainLayout>
      ...
      {user.userTasks.map((task, index) => (
        <ListItem button key={index}>
          ...
          <IconButton edge="end" aria-label="edit-task" onClick={(event) => handleEditTask(event)}>
            <EditIcon />
          </IconButton>
          <IconButton edge="end" aria-label="delete-task" onClick={(event) => {
      ...
      {formTask && <FormTask user={user} task={task} passFormUser={setFormTask} updateSelected={setTask} />}
